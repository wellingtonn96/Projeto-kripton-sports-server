exports.colaboradores = (application, req, res) => {
  ...
  const colaboradoresModel = new application.app.models.ColaboradoresDao(
    connection,
  );
  colaboradoresModel
    .listarColaboradores()
...
exports.colaborador_salvar = (application, req, res) => {
  ...
  colaboradoresModel
    .cadastrarColaborador(dadosForm)
    .then(result => res.redirect('/colaboradores'))
    .catch(erros => {
      console.log(erros);
    });
};
...
exports.nutricionistaSalvar = function (application, req, res) {
  ...
  colaboradoresModel
    ...
    .then(colaborador => {
      ...
      colaboradoresModel
        .cadastrarNutricionista(nutricionista)
        .then(result => {
