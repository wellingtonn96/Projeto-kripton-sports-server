...
class ColaboradoresDao {
  ...
  // 		this.connection.query('select * from tipoColaborador t, colaborador u where t.idTipoColaborador =  u.idTipo order by u.idColaborador desc',
  // 		(error, results)=>{
  // 			if(error){
  // 				reject(error)
  // 			}else(
  ...
  public create(colaborador: any): Promise<void> {
    return new Promise((resolve, reject) => {
  ...
  // 	return new Promise((resolve, reject)=>{
  // 		this.connection.query("DELETE FROM colaborador  WHERE idColaborador = ? ",
  // 		[id],
  // 		 (error, results)=>{
  // 			 if(error){
  // 				 reject(error)
  ...
  // 	return new Promise((resolve, reject)=>{
  // 		this.connection.query('insert into colaborador set ? ',
  // 		[id],
  // 		(error, results)=>{
  // 			if(error){
  // 				reject(error)
  ...
  // 	return new Promise((resolve, reject)=>{
  // 		this.connection.query('SELECT * FROM colaborador WHERE idColaborador = ?',
  // 			[id],
  // 			(error, results)=>{
  // 				if(error){
  // 					reject(error)
  ...
  // 	return new Promise((resolve, reject)=>{
  // 	this.connection.query("UPDATE colaborador set ? WHERE idColaborador = ? ",
  // 	[dados, id],
  // 		(error, results)=>{
  // 			if(error){
  // 				reject(error)
